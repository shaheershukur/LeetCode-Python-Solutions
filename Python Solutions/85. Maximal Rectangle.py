# LeetCode Problem Title : 85. Maximal Rectangle
# LeetCode Problem Link  : https://leetcode.com/problems/maximal-rectangle/
# Solution Explanation   : https://youtu.be/9axHSSBfjcE
